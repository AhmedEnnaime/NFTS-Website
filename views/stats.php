            ...
            <div class="container">
                <div class="main-cards">
                    ...
                    <div class="card">
                        ...
                        <span class="text-primary font-weight-bold"><?php foreach ($counts as $count) {
                                                                        echo $count;
                                                                    } ?></span>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <span class="text-primary font-weight-bold"><?php foreach ($expensive as $exp) {
                                                                        echo $exp['name'];
                                                                    } ?></span>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <span class="text-primary font-weight-bold"><?php foreach ($cheap as $chp) {
                                                                        echo $chp['name'];
                                                                    } ?></span>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <span class="text-primary font-weight-bold"><?php foreach ($userNum as $usercount) {
                                                                        echo $usercount;
                                                                    } ?></span>
                    </div>
